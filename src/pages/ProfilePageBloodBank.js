...
const ProfilePageBloodBank = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    pricePerUnit: currentUser?.pricePerUnit || '',
    bloodStock: {
      'A+': currentUser?.bloodStock?.['A+'] || 0,
      'A-': currentUser?.bloodStock?.['A-'] || 0,
      'B+': currentUser?.bloodStock?.['B+'] || 0,
      'B-': currentUser?.bloodStock?.['B-'] || 0,
      'AB+': currentUser?.bloodStock?.['AB+'] || 0,
      'AB-': currentUser?.bloodStock?.['AB-'] || 0,
      'O+': currentUser?.bloodStock?.['O+'] || 0,
      'O-': currentUser?.bloodStock?.['O-'] || 0,
    },
  });
      ...
      <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <div className="mb-8 text-center">
            <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Your Blood Bank Profile</h1>
            <p className="mt-2 text-lg text-gray-600">
              Update your details to manage blood inventory and pricing effectively
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="bg-white shadow-xl rounded-xl overflow-hidden">
            <div className="bg-gradient-to-r from-red-500 to-red-600 px-6 py-5">
              <h2 className="text-xl font-semibold text-white">Blood Bank Details</h2>
            </div>
...
export default ProfilePageBloodBank;