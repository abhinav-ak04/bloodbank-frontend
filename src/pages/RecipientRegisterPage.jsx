...
const RecipientRegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/recipient'); // Navigate to recipient dashboard after successful registration
    } catch (err) {
      setMessage({
        type: 'error',
        ...
        <div className="max-w-3xl mx-auto">
          <div className="mb-8 text-center">
            <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">
              Register as a Blood Recipient
            </h1>
            <p className="mt-2 text-lg text-gray-600">
              Join our community to receive timely blood donations when you need them
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="bg-white shadow-xl rounded-xl overflow-hidden">
            <div className="bg-gradient-to-r from-red-500 to-red-600 px-6 py-5">
              <h2 className="text-xl font-semibold text-white">Create Your Recipient Account</h2>
            </div>
